...
public class hospital extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        vtuno = new javax.swing.JTextField();
        ...
        vtuno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                vtunoActionPerformed(evt);
            }
        });
        getContentPane().add(vtuno);
        vtuno.setBounds(330, 110, 200, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
String name,year,disease,accom,diagnosis,no;int vtu;
if((no=vtuno.getText()).equals("")||no.length()!=4){
    throw new Exception("VTU NO IS WRONG");
}
if((name=tf1.getText()).equals("")){
   ...
   String data=no+"-"+name.toUpperCase()+"-"+year.toUpperCase()+"-"+disease.toUpperCase()+"-"+accom.toUpperCase()+"-"+diagnosis.toUpperCase();
 synchronized(this){
   s=new Socket(InetAddress.getLocalHost(),port);
   dout=new ObjectOutputStream(s.getOutputStream());
   din=new ObjectInputStream(s.getInputStream());
   dout.writeObject((Object)1);
   dout.flush();
   dout.writeUTF(data);
   dout.flush();
   fik=din.read();
 }
   //String fik=din.readUTF();
   System.out.println("hs:1 ="+fik);
   if(fik>=0){
       System.out.println("message"+fik);
       ...
       JOptionPane.showMessageDialog(this,"DATA NOT ENTERED");System.out.println("here 5");
       this.dispose();
       new hospital().setVisible(true);
   }
        }
    ...
    private void vtunoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vtunoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_vtunoActionPerformed
    ...
    private javax.swing.JTextField vtuno;
